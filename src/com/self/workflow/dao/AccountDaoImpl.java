...
public class AccountDaoImpl implements AccountDao {
	...
	public String createAccount(Account account) {
		...
		try {
			...
			String query = "INSERT INTO account(companyName, primaryAdminEmail, companyLogoPath, maxUser)"
					+ "VALUES(?, ?, ?, ?)";
			preparedStatement = con.prepareStatement(query);
			preparedStatement.setString(1, companyName);
			preparedStatement.setString(2, primaryAdminEmail);
			preparedStatement.setString(3, companyLogoPath);
			preparedStatement.setString(4, maxUser);
